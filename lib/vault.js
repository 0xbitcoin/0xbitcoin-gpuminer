  ...
  async requirePassword(require)
  {
   ...
   async handleAccountCommand(subsystem_command,subsystem_option)
    ...
    async handleConfigCommand(subsystem_command,subsystem_option)
    {
      ...
      if(subsystem_command === 'threadsize' )
      {
        this.setThreadsize(subsystem_option);
        await this.saveVaultData(  );

      }

      if(subsystem_command === 'blocksize' )
      {
        this.setBlocksize(subsystem_option);
        await this.saveVaultData(  );
      ...
      if(subsystem_command === 'list' )
      {
        ...
        console.log('CUDA Threadsize:', this.getThreadsize())

        console.log('CUDA Blocksize:', this.getBlocksize())
    ...
    {
      var int_threadsize = parseInt(threadsize);

      if(int_threadsize >= 1 && int_threadsize < 99999)
      {
          vaultData.threadsize = int_threadsize;
          console.log('Set threadsize: ', int_threadsize);
      }else{
        console.log('You sure???: ', int_threadsize, "... try again.");
      }
    ...
    {
      var int_blocksize = parseInt(blocksize);

      if(int_blocksize >= 1 && int_blocksize < 99999)
      {
          vaultData.blocksize = int_blocksize;
          console.log('Set blocksize: ', int_blocksize);
      }else{
        console.log('You sure???: ', int_blocksize, "... try again.");
      }
    ...
    getThreadsize()
    {
      return vaultData.threadsize;
    },

    getBlocksize()
    {
      return vaultData.blocksize;
    },
